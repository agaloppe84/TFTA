...
bagin = Foodtruck.create!(user: dorothée, sku:"", name:"Bag in", format:"truck", min_capacity:"40", max_capacity:"250", free_radius_max:"50", radius_max:"150", km_price_cents:"120", address:"bordeaux", culinary_style: bagel, photo_urls:["http://thefoodtruck.agency/wp-content/uploads/2015/11/bagin-vignette.jpg","http://thefoodtruck.agency/wp-content/uploads/2015/11/Bagin-bandeau.jpg"])
...
eltacodeldiablo = Foodtruck.create!(user: paul, sku:"", name:"El tacos del Diablo", format:"truck", min_capacity:"80", max_capacity:"250", free_radius_max:"50", radius_max:"150", km_price_cents:"120", address:"paris", culinary_style: bagel, description: "Lorem Ipsum blablabla", photo_urls:["http://thefoodtruck.agency/wp-content/uploads/2015/11/eltacodeldiablo-vignette.jpg","http://thefoodtruck.agency/wp-content/uploads/2015/11/eltacodeldiablo-bandeau.jpg"])
...
bbagin = Foodtruck.create!(user: dorothée, sku:"", name:"Bag in", format:"truck", min_capacity:"40", max_capacity:"250", free_radius_max:"50", radius_max:"150", km_price_cents:"120", address:"bordeaux", culinary_style: bagel, photo_urls:["http://thefoodtruck.agency/wp-content/uploads/2015/11/bagin-vignette.jpg","http://thefoodtruck.agency/wp-content/uploads/2015/11/Bagin-bandeau.jpg"])
wbestcoast = Foodtruck.create!(user: pierre, sku:"", name:"West Coast", format:"truck", min_capacity:"60", max_capacity:"250", free_radius_max:"50", radius_max:"150", km_price_cents:"120", address:"limoges", culinary_style: burger, photo_urls:["http://thefoodtruck.agency/wp-content/uploads/2015/11/WestCoastBurger-vignette.jpg","http://thefoodtruck.agency/wp-content/uploads/2015/11/WestCoastBurger-bandeau.jpg"])
ebltacodeldiablo = Foodtruck.create!(user: paul, sku:"", name:"El tacos del Diablo", format:"truck", min_capacity:"80", max_capacity:"250", free_radius_max:"50", radius_max:"150", km_price_cents:"120", address:"paris", culinary_style: bagel, photo_urls:["http://thefoodtruck.agency/wp-content/uploads/2015/11/eltacodeldiablo-vignette.jpg","http://thefoodtruck.agency/wp-content/uploads/2015/11/eltacodeldiablo-bandeau.jpg"])
lbespouletoquees = Foodtruck.create!(user: dorothée, sku:"", name:"Les Poules Toquées", format:"truck", min_capacity:"80", max_capacity:"250", free_radius_max:"50", radius_max:"150", km_price_cents:"120", address:"paris", culinary_style: burger, photo_urls:["http://thefoodtruck.agency/wp-content/uploads/2016/03/lespoulestoquees-vignette.jpg","http://thefoodtruck.agency/wp-content/uploads/2016/03/lespoulestoquees-bandeau.jpg"])
...
dish_entree2 = Dish.create!(category: "entrée", foodtruck: eltacodeldiablo, name:"Salade mexicaine", description:"Salade mexicaine en fleurs de tortillas" ,price_cents:"250", photo_url: "http://www.cookismo.fr/wp-content/uploads/2012/09/tomates_farcies_guacamole_crevettes440%C2%A9christelle-vogel_cookismo.jpg")
